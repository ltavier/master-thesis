"""
In this file, we replace a missing characteristic with the cross-sectional median of that characteristic during that month.

We rank-normalize all characteristics into the interval (−1, 1) for each month t.
